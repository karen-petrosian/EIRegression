...
def execute(save_dir, n_buckets=3, i=None, bucketing_method="quantile", single_rules_breaks=3):
    ...
    data = pd.read_csv(project_root / "datasets/house_16H.csv")
    # data = pd.read_csv("/Users/eddavtyan/Documents/XAI/Projects/EIRegression/examples/datasets/house_16H.csv")
    target = "price"
    ...
    regressor_optimizer = ModelOptimizer(search_method="random", n_iter=500)
